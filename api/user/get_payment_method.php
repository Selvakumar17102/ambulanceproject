            ...
            if($result->num_rows > 0){
                ...
                if($result->num_rows > 0){
                    ...
                    while($row = $result->fetch_assoc()){
                        $output_array['GTS'][$i]['payment_method_id'] = (int)$row['payment_method_id'];
                        $output_array['GTS'][$i]['payment_method_name'] = $row['payment_method_name'];
                        $output_array['GTS'][$i]['payment_method_status'] = (int)$row['payment_method_status'];
                        $i++;
                    }
