<?php
    ...
    if(isset($_POST['add'])){
        ...
        if($_POST['category']){  $category = $_POST['category'];  }else{  $category = 0;  }

        $sql = "INSERT INTO banner (category_id,banner_location) VALUES ('$category','$position')";
        if($conn->query($sql) === TRUE){
            $sql = "SELECT * FROM banner ORDER BY banner_id DESC LIMIT 1";
    ...
    if(isset($_POST['edit'])){
        ...
        $sql = "UPDATE banner SET category_id='$category',banner_location='$position' WHERE banner_id='$banner_id'";
        if($conn->query($sql) === TRUE){
            if($image){
...
<head>
    ...
    <title>App Banners | Salvo Ambulance</title>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <label>Banner Image</label>
                                                                    ...
                                                                    <!-- <input type="text" name="banner" id="banner" class="form-control" placeholder="Banner Url" autocomplete="off"> -->
                                                                    <small style="color:red;font-weight:700">*Top Banner:(1312 * 640).</small>
                                                                    <small style="color:red;font-weight:700">*Bottom Banner:(1312 * 479).</small>
                                                                </div>
                                                                <div class="col-sm-6">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-responsive">
                                    <table class="table mb-4 convert-data-table">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM banner ORDER BY banner_arrangement";
                                                $result = $conn->query($sql);
                                                $count = 0;
                                                while($row = $result->fetch_assoc())
                                                {
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                                        <div class="modal-content">
                                                                            <form method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-5">
                                                                                            ...
                                                                                            <!-- <input type="text" name="banner" id="banner<?php echo $count ?>" class="form-control" placeholder="Banner" autocomplete="off" value="<?php echo $row['banner_image'] ?>"> -->
                                                                                            <small style="color:red;font-weight:700">*Top Banner:(1312 * 640).</small>
                                                                                            <small style="color:red;font-weight:700">*Bottom Banner:(1312 * 479).</small>
                                                                                        </div>
                                                                                        ...
                                                                                        <label>Banner Position</label>
                                                                                            <select name="position" id="position<?php echo $count ?>" class="form-control">
                                                                                                <option <?php echo $t ?> value="0">Top</option>
                                                                                                <option <?php echo $b ?> value="1">Bottom</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row mt-2">
                                                                                        <div class="col-sm-12">
                                                                                        <label>Category</label>
                                                                                            <select name="category" id="category<?php echo $count ?>" class="form-control">
                                                                                                <?php
                                                                                                ...
                                                                                                ?>
                                                                                                        <option <?php echo $s ?> value="<?php echo $row1['category_id'] ?>"><?php echo $row1['category_name'] ?></option>
                                                                                                <?php
                                                                                                    }
                                                                                                ?>
                                                                                            </select>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                                                    <button type="submit" name="edit" onclick="return bannerEdit(<?php echo $banner_id ?>)" class="btn btn-primary">Save</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
