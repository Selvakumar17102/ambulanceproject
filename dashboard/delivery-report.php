...
<head>
    ...
    <title><?php echo $delivery_partner['delivery_partner_name'] ?>'s Report | Instant Ambulance</title>
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <!-- <div class="row layout-top-spacing" id="filterButton">
                    <div class="col-sm-12">
                        <button class="btn btn-outline-dark float-right" onclick="showFilter()">Filter</button>
                    </div>
                </div> -->
                <div class="row layout-top-spacing hide" id='filter'>
                    <div class="col-sm-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary float-right" onclick="deliveryfilterReport('delivery-report.php',<?php echo $delivery_partner_id ?>)">Filter</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row layout-top-spacing">
                    <div class="col-sm-12">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <h4><?php echo $delivery_partner['delivery_partner_name'] ?>'s Report</h4>
                            </div>
                            <div class="widget-content widget-content-area">
                                    ...
                                    <table class="table mb-4" id="Table">
                                        ...
                                        <tbody>
                                            <?php
                                                $count = 1;
                                                if($control == 0){
                                                    $sql = "SELECT * FROM orders WHERE booking_date BETWEEN '$start' AND '$end' AND order_status='7' AND delivery_partner_id='$delivery_partner_id'";
                                                } else{
                                                    $sql = "SELECT * FROM orders WHERE booking_date BETWEEN '$start' AND '$end' AND order_status='7' AND delivery_partner_id='$delivery_partner_id' AND login_id='$login_id'";
                                                }
                                                $result = $conn->query($sql);
