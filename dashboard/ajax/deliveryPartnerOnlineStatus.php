<?php
    ...
    if(!empty($_POST['delivery_partner_id'])){
        ...
        if($row['delivery_partner_online_status'] == 0){
            $status = 1;
        }

        $sql = "UPDATE delivery_partner SET delivery_partner_online_status='$status' WHERE delivery_partner_id='$delivery_partner_id'";
