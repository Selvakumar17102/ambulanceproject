                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-responsive">
                                    ...
                                    <table class="table mb-4" id="Table">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT *,a.blood_group as donorbloodgroup FROM blood_donation a LEFT OUTER JOIN user b ON a.user_id=b.user_id LEFT OUTER JOIN city c ON a.donor_city_id=c.city_id WHERE a.create_date BETWEEN '$start' AND '$end'";
                                                $result = $conn->query($sql);
                                                $count = 1;
                                                while($row = $result->fetch_assoc()){
                                                    $user_id = $row['user_id'];
