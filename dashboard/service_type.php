...
<head>
    ...
    <title>Service Types | Instant Ambulance</title>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <label class="switch s-icons s-outline s-outline-success" style="margin-bottom: 0px !important">
                                                                <input type="checkbox" id="S<?php echo $row['service_type_id'] ?>" <?php echo $status ?> onclick="return servicetypeStatus(<?php echo $row['service_type_id'] ?>)">
