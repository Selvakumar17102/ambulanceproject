...
<head>
    ...
    <title>Cancelled Trips | Instant Ambulance</title>
                    ...
                    <div class="col-sm-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary float-right" onclick="filterReport('cancelledOrder1.php')">Filter</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-4 convert-data-table">
                                        ...
                                        <tbody>
                                            <?php
                                                if($control == 0){
                                                    $sql = "SELECT * FROM orders WHERE order_status='0' AND (booking_date BETWEEN '$start' AND '$end') ORDER BY order_id DESC";
                                                } else{
                                                    $sql = "SELECT * FROM orders WHERE order_status='0' AND (booking_date BETWEEN '$start' AND '$end') AND login_id='$login_id' ORDER BY order_id DESC";
                                                }
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo $row['cancelled_by'] ?></td>
                                                            <td class="text-center"><?php echo $row['cancel_reason'] ?></td>
