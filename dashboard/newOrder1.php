<?php
    ...
    if(isset($_POST['delete'])){
        ...
        if($result->num_rows > 0){
            ...
            if($conn->query($sql) === TRUE){
                header('Location: newOrder1.php?msg=Order cancelled!');
            }
        }
    }
    if(isset($_POST['ready'])){
        ...
        if($result->num_rows > 0){
            ...
            // $notificationData['body'] = 'Your order is ready!';
            // $notificationData['image'] = 'http://senthilmuruganhotel.com/dashboard/assets/img/Ready.png';
            // $notificationData['type'] = 0;
            // $notificationData['status'] = 1;
            // $notificationData['order_id'] = $id;

            // $title = 'Hi '.$user_name;
            // $res = sendNotificationUser($user_id,$title,'Your order is shipped!','',$id, '3');
            ...
            if($conn->query($sql) === TRUE){
                header('Location: newOrder1.php?msg=Order ready!');
            } else{
                header('Location: newOrder1.php?msg=No Order ready!');
            }
        }
    }
?>
...
<head>
    ...
    <title>Active Orders | Instant Ambulance</title>
...
<body class="sidebar-noneoverflow">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-4 convert-data-table">
                                                ...
                                                <tbody id="processingTablebody">
                                                    <?php
                                                        if($control == 0){
                                                            $sql = "SELECT * FROM orders WHERE order_status='2' AND order_type='0' ORDER BY order_id DESC";
                                                        } else{
                                                            $sql = "SELECT * FROM orders WHERE order_status='2' AND order_type='0' AND login_id='$login_id' ORDER BY order_id DESC";
                                                        }
                                                        $result = $conn->query($sql);
                                                        if($result->num_rows > 0){
                                                            $i = 1;
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-4 convert-data-table">
                                                ...
                                                <tbody id="readyTablebody">
                                                    <?php
                                                        if($control == 0){
                                                            $sql = "SELECT * FROM orders WHERE order_status='3' AND order_type='0' ORDER BY order_id DESC";
                                                        } else{
                                                            $sql = "SELECT * FROM orders WHERE order_status='3' AND order_type='0' AND login_id='$login_id' ORDER BY order_id DESC";
                                                        }
                                                        $result = $conn->query($sql);
                                                        if($result->num_rows > 0){
                                                            $i = 1;
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    <td class="text-center"><?php echo $i++ ?></td>
                                                                    <td class="text-center"><a style="color: #790c46;font-weight: 600" href="view-order1.php?id=<?php echo $row['order_id'] ?>"><?php echo $row['order_string'] ?></a></td>
                                                                    <td class="text-center"><?php echo $pickup_otp ?></td>
                                                                    <td class="text-center"><?php echo $bookings ?></td>
                                                                    <td class="text-center"><span class="<?php echo $spanClass ?>"><?php echo $serviceTypeTable['service_type_name'] ?></span></td>
                                                                    <td class="text-center"><?php echo $row1['user_name'] ?></td>
                                                                    <td class="text-center"><?php echo $row['pickup_address'] ?></td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-4 convert-data-table">
                                                ...
                                                <tbody id="pickupTablebody">
                                                    <?php
                                                        if($control == 0){
                                                            $sql = "SELECT * FROM orders WHERE (order_status='4' OR order_status='5' OR order_status='6') AND order_type='0' ORDER BY order_id DESC";
                                                        } else{
                                                            $sql = "SELECT * FROM orders WHERE (order_status='4' OR order_status='5' OR order_status='6') AND order_type='0' AND login_id='$login_id' ORDER BY order_id DESC";
                                                        }
                                                        $result = $conn->query($sql);
                                                        if($result->num_rows > 0){
                                                            $i = 1;
    ...
    <script src="assets/js/instantOrder.js"></script>
